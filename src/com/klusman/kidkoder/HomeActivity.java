...
public class HomeActivity extends Activity {
	...
	private void onCreateIfConnected(){
		...
		kidsBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(HomeActivity.this, ChildList.class);
		...
		alrgBtn.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(HomeActivity.this, AllergyList.class);
		        startActivity(intent);
			}
		});
		...
		QLinksBtn.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(HomeActivity.this, QuickLinksActivity.class);
		        startActivity(intent);
			}
		});
	...
	public void myToast(String text){  
		...
		Toast toast = Toast.makeText(HomeActivity.this, textIN, duration);
